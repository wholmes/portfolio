...
<body>
    ...
    <section id="projects" class="projects-bento">
        ...
        <div class="bento-grid">
            ...
            $techStacks = [
                'Datalayer Tracker' => ['PHP', 'JavaScript', 'WordPress'],
                'Tab Anything Block' => ['JavaScript', 'React', 'WordPress', 'CSS'],
                'Code My Brand' => ['PHP', 'JavaScript', 'CSS', 'WordPress'],
                'Datalayer Tracker SaaS' => ['PHP', 'JavaScript', 'MySQL', 'CSS'],
                'eBook' => ['Markdown', 'HTML', 'CSS'],
                'Prompt Enhancer' => ['JavaScript', 'Python', 'AI/ML'],
                'Prompt Builder' => ['JavaScript', 'React', 'CSS'],
                'Casetext Websites Manager' => ['PHP', 'JavaScript', 'MySQL'],
                'Tag Management Consulting' => ['JavaScript', 'GTM', 'GA4'],
                'Web Development' => ['PHP', 'JavaScript', 'HTML', 'CSS']
            ];
            
            foreach ($projects as $project): 
                $stack = isset($techStacks[$project['title']]) ? $techStacks[$project['title']] : [];
            ?>
