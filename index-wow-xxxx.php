...
<head>
    ...
    <style>
        * {
        ...
        .brain-left .brain-icon svg {
            color: var(--primary);
        }

        .brain-right .brain-icon svg {
            color: var(--secondary);
        }
        ...
        .synapse-text {
            ...
            font-weight: bold;
            z-index: 1;
            animation: rotate-synapse 4s linear infinite;
        }

        @keyframes rotate-synapse {
            ...
            <div class="hero-image-container">
                <div class="brain-container">
                    <div class="brain-split">
                        <div class="brain-half brain-left">
                            <div class="brain-label">Logic</div>
                        ...
                        <div class="brain-center">
                            <div class="brain-synapse">
                                <div class="synapse-pulse"></div>
                                <div class="synapse-text">×</div>
                            </div>
                        </div>
                        <div class="brain-half brain-right">
                            <div class="brain-label">Creativity</div>
                            <div class="brain-content">
                                <div class="brain-icon">
                                    <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                    ...
                    <div class="brain-footer">
                        Where technical precision meets creative innovation
                    </div>
                </div>
            </div>
        </div>
